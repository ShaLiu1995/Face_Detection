...
if __name__ == '__main__':
    ...
    for difficulty in ['easy', 'hard']:
        TEST_FEATURE_FILE = 'feature_array_val_{}.bin'.format(difficulty)
        TEST_BBX_FILE = 'bbx_array_val_{}.bin'.format(difficulty)
        ...
        evaluate_test_set(0, TEST_SIZE, ytest, 'resized_img_val_{}'.format(difficulty))
